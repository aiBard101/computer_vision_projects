...
Arrow = pygame.image.load('assests/Arr2.png')
flo = pygame.image.load('assests/foll.png')
logo = pygame.image.load('assests/LOGO (2).jpg')
lEdge = pygame.image.load('assests/Edg.png')
bEdg = pygame.image.load('assests/bEdg.png')
ball = pygame.image.load('assests/Ball.png')
